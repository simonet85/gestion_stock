...
<div class="container mx-auto px-6 py-8">
    <div class="flex justify-between items-center mb-8">
        <h1 class="text-2xl font-bold text-gray-800">Liste des Utilisateurs et leurs Rôles</h1>
                                ...
                                <div class="flex flex-wrap gap-2">
                                    @foreach ($user->roles as $role)
                                        <span class="px-2 py-1 text-xs font-semibold rounded-full 
                                            {{ $role->name === 'Administrateur' ? 'bg-purple-100 text-purple-800' : 
                                               ($role->name === 'Gestionnaire' ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-800') }}">
                                            {{ $role->name }}
                                        </span>
                                    @endforeach
                                </div>

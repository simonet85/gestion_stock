    ...
    <div class="bg-white rounded-xl shadow-lg max-w-2xl mx-auto">
        <div class="p-6 border-b border-gray-200">
            <div class="flex items-center">
                ...
                <h2 class="text-lg font-medium text-gray-800">Modifier les Informations</h2>
            </div>
        </div>
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <input type="text" 
                           name="nom" 
                           id="nom" 
                           value="{{ old('nom', $category->nom_catégorie) }}" 
                ...
                <div>
                    ...
                    <textarea name="description" 
                              id="description" 
                              rows="4" 
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200">{{ old('description', $category->description) }}</textarea>
                </div>
            </div>

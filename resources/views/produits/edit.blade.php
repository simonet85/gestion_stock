...
<div class="container mx-auto px-6 py-8">
    ...
    <div class="bg-white rounded-xl shadow-lg max-w-3xl mx-auto">
        ...
        <form action="{{ route('produits.update', $produit->id) }}" method="POST" class="p-6 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <!-- fetch category beloging to a particular  produit-->
                <div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="description" 
                              id="description" 
                              rows="3" 
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200">{{ old('description', $produit->description) }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <input type="number" 
                           ...
                           value="{{ old('seuil_reapprovisionnement', $produit->seuil_reapprovisionnement) }}"
                           min="0"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200" 
                           required>
                </div>
